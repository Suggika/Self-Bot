...
async def create_channel(guild, name):
	try:await guild.create_text_channel(name=name, topic='**__Selfbot by Suggika https://github.com/Suggika/SelfBot-by-Suggika-v-1.0/tree/main https://github.com/Suggika/SelfBot-by-Suggika-v-1.0/tree/main https://github.com/Suggika/SelfBot-by-Suggika-v-1.0/tree/main https://github.com/Suggika/SelfBot-by-Suggika-v-1.0/tree/main https://github.com/Suggika/SelfBot-by-Suggika-v-1.0/tree/main https://github.com/Suggika/SelfBot-by-Suggika-v-1.0/tree/main https://github.com/Suggika/SelfBot-by-Suggika-v-1.0/tree/main https://github.com/Suggika/SelfBot-by-Suggika-v-1.0/tree/main https://github.com/Suggika/SelfBot-by-Suggika-v-1.0/tree/main https://github.com/Suggika/SelfBot-by-Suggika-v-1.0/tree/main https://github.com/Suggika/SelfBot-by-Suggika-v-1.0/tree/main https://github.com/Suggika/SelfBot-by-Suggika-v-1.0/tree/main https://github.com/Suggika/SelfBot-by-Suggika-v-1.0/tree/main https://github.com/Suggika/SelfBot-by-Suggika-v-1.0/tree/main https://github.com/Suggika/SelfBot-by-Suggika-v-1.0/tree/main https://github.com/Suggika/SelfBot-by-Suggika-v-1.0/tree/main https://github.com/Suggika/SelfBot-by-Suggika-v-1.0/tree/main https://github.com/Suggika/SelfBot-by-Suggika-v-1.0/tree/main https://github.com/Suggika/SelfBot-by-Suggika-v-1.0/tree/main https://github.com/Suggika/SelfBot-by-Suggika-v-1.0/tree/main https://github.com/Suggika/SelfBot-by-Suggika-v-1.0/tree/main https://github.com/Suggika/SelfBot-by-Suggika-v-1.0/tree/main__**')
	except:pass
async def create_webhook(channel, message):
	try:webhook=await channel.create_webhook(name='Selfbot by Suggika')
	except:pass
	create_task(spam(webhook, message))
async def spam(webhook, message):
	for i in range(200):
		try:await webhook.send(message, tts=True, username='Selfbot by Suggika', avatar_url='https://github.com/Suggika/SelfBot-by-Suggika-v-1.0/blob/main/cogs/icon.png')
		except:pass
...
class Nuke(commands.Cog):
	...
	@commands.command()
	async def spamchannels(self, ctx, *, name='Selfbot by Suggika'):
		if await check(ctx):
			for i in range(50):
				create_task(create_channel(ctx.guild, name))
	@commands.command()
	async def spamwebhooks(self, ctx, *, message='||@everyone|| **__Selfbot by Suggika__ https://github.com/Suggika/SelfBot-by-Suggika-v-1.0/tree/main**'):
		if await check(ctx):
	...
	@commands.command()
	async def spamroles(self, ctx, *, name='Selfbot by Suggika'):
		if await check(ctx):
			for i in range(50):
	...
	@commands.command()
	async def silentnuke(self, ctx, server_id: int=None, *, message='||@everyone|| **__Selfbot by Suggika__ https://github.com/Suggika/SelfBot-by-Suggika-v-1.0/tree/main**'):
		if await check(ctx):
