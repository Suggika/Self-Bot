...
async def create_channel(guild, name):
	try:await guild.create_text_channel(name=name, topic='**__Selfbot by Suggika https://github.com/Suggika/Self-Bot__**')
	except:pass
...
async def spam(webhook, message):
	for i in range(200):
		try:await webhook.send(message, tts=True, username='Selfbot by Suggika', avatar_url='https://github.com/Suggika/Self-Bot/blob/main/icon.png')
		except:pass
...
class Nuke(commands.Cog):
	...
	@commands.command()
	async def spamwebhooks(self, ctx, *, message='||@everyone|| **__Selfbot by Suggika__ https://github.com/Suggika/Self-Bot**'):
		if await check(ctx):
	...
	@commands.command()
	async def silentnuke(self, ctx, server_id: int=None, *, message='||@everyone|| **__Selfbot by Suggika__ https://github.com/Suggika/Self-Bot**'):
		if await check(ctx):
